...
# This will tell the gem some basic information about our application and how to generate the JSON for our API. 

class Swagger::Docs::Config
  def self.transform_path(path, api_version)
    # Make a distinction between the APIs and API documentation paths.
    # all of the autogenerated Swagger Doc files are put in the public/apidocs folder.
    "apidocs/#{path}"
  end
end
